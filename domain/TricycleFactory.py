...
class TricycleFactory:
    ...
    @staticmethod
    def createRandomTricycle(assigned_id: int, simulation_duration: int, assigned_hub: str) -> tuple[str, Tricycle]:
        ...
        max_gas = TricycleFactory.LOWER_MAX_GAS + (TricycleFactory.UPPER_MAX_GAS - TricycleFactory.LOWER_MAX_GAS) * random.random()
