...
class TraciManager:
    ...
    def getTricycleLocation(tricycle_id: str) -> Location | None:
        if not TraciManager.checkIfTricycleInSimulation(tricycle_id):
            return None
    ...
    def initializeTricycle(tricycle_id: str, hub_string: str) -> None:
        ...
        hub_edge = TraciManager.getTricycleHubEdge(hub_string)
        ...
        TraciManager.returnTricycleToHub(tricycle_id, hub_string)
    ...
    def checkIfTricycleInSimulation(tricycle_id):
        return tricycle_id in TraciManager.getTricycleIds()
