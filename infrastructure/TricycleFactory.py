...
class TricycleFactory:
    ...
    def createRandomTricycle(self, assigned_id: int, assigned_hub: str) -> tuple[str, Tricycle]:
        ...
        return (trike_name, Tricycle(trike_name, assigned_hub, start_time, end_time, max_gas, gas_consumption, usual_gas_payment, gets_full_tank, farthest_distance, daily_expense, patience, aspired_price, minimum_price))
