...
class TricycleFactory:
    ...
    def createRandomTricycle(self, assigned_id: int, simulation_duration: int, assigned_hub: str) -> tuple[str, Tricycle]:
        ...
        max_gas = stats.gamma.rvs(4.310842116036499  , loc=7.546639006032087  , scale=0.5024555276240792)
        ...
        index = np.random.choice(list(range(7)), p=w_gc)
        ...
        index = np.random.choice(list(range(6)), p=w_gp)
        ...
        index = np.random.choice(list(range(6)), p=w_e)
        ...
        index = np.random.choice(list(range(6)), p=w_d)
